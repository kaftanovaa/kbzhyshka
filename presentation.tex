    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \begin{center}
                ...
                \href{https://github.com/kaftanovaa/se-toolkit-hackathon}{
                    \color{blue}\underline{github.com/kaftanovaa/se-toolkit-hackathon}
                }
                
                \vspace{0.3cm}
                
                \qrcode[height=3.5cm]{https://github.com/kaftanovaa/se-toolkit-hackathon}
            \end{center}
        \end{column}
